        ...
        <section className="bg-background px-6 py-20 text-center" aria-labelledby="hero-heading">
          ...
          <div className="mt-12 mx-auto grid max-w-4xl grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            >
              ...
              <form role="search" className="flex gap-2" onSubmit={(e) => { e.preventDefault(); navigate({ to: '/search', search: { q: query.trim(), city: '', radiusKm: undefined, tagIds: [], maxPrice: undefined, from: undefined } }) }}>
